...
- **Tier 2 — Thin integration**: a separate repo (e.g. [`ding-action`](https://github.com/ding-labs/ding-action) for GitHub Actions). Built only when a recipe self-promotes via the escalation rubric printed at the bottom of each recipe.
